...
execute as @a[predicate=strawberry:in_overworld] unless score @s sp_WarpX = @s sp_WarpX run scoreboard players operation @s sp_WarpX = @s sp_x
execute as @a[predicate=strawberry:in_overworld] unless score @s sp_WarpY = @s sp_WarpY run scoreboard players operation @s sp_WarpY = @s sp_y
execute as @a[predicate=strawberry:in_overworld] unless score @s sp_WarpZ = @s sp_WarpZ run scoreboard players operation @s sp_WarpZ = @s sp_z
...
# On Success
execute as @e[tag=sp_warp_saver] at @s if entity @s[predicate=strawberry:in_overworld] run function strawberry:coordinate_saver/success

# On Failure
execute as @e[tag=sp_warp_saver] at @s unless entity @s[predicate=strawberry:in_overworld] run function strawberry:coordinate_saver/failure
